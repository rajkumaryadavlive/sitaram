...
const MembershipLetterPadCopy = ({ member }) => {
  return (
      ...
      <header className="bg-red-800 text-white p-2 sm:p-6 rounded-t-lg shadow-md relative">
        ...
        <div className="flex flex-row sm:flex-row items-center justify-between border-t border-white sm:pt-4 space-y-2 sm:space-y-0 space-x-2 sm:space-x-4">
          <div className="text-center text-white w-full sm:w-1/3">
            <p className=" text-xs sm:text-lg font-semibold">Akhilesh Yadav</p>
            <p className='text-xs sm:text-base'>President</p>
          ...
          <div className="text-left text-xs sm:text-base text-white  sm:w-1/3">
            <p className="flex items-center mb-1"><FaMapMarkerAlt className="inline-block mr-2" /> 19, Vikramaditya Marg, Lucknow, Uttar Pradesh</p>
            <p className="flex items-center mb-1"><FaPhone className="inline-block mr-2" /> +91 (555) 123-4567</p>
            <p className="flex items-center"><FaEnvelope className="inline-block mr-2" /> info@samajwadiparty.in</p>
          </div>
        </div>
      </header>
      ...
      <main className="flex-grow p-8 bg-white rounded-lg shadow-inner">
        <div className="text-gray-800">
          ...
          <p className="text-md leading-relaxed">
            Sincerely,<br />
            <span className="font-bold">Akhilesh Yadav</span><br />
            President<br />
            Samajwadi Party
          </p>
        </div>
...
export default MembershipLetterPadCopy;
